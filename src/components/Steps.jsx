...
const steps = [
  { name: 'CARGA DE INFORMACION INICIAL', description: 'Plano de construcción y declaración jurada', href: '#', status: 'complete', num: 1},
  {
  ...
  { name: 'COMPROBANTE DE PAGO', description: 'Pago del permiso y fecha de pago', href: '#', status: 'upcoming', num: 3},
  { name: 'PERMISO DE EDIFICACION', description: 'Expediente aprobado', href: '#', status: 'upcoming', num: 4},
]
          ...
          <li key={step.name} className={classNames(stepIdx !== steps.length - 1 ? 'pb-10' : '', 'relative')}>
            {step.status === 'complete' ? (
              <>
                ...
                <a href={step.href} className="group relative flex items-start" onClick={() => sendData(step)}>
              ...
              <>
                ...
                <a href={step.href} className="group relative flex items-start" aria-current="step" onClick={() => sendData(step)}>
